...
$.validator.addMethod("checkExpirationDate1", function(){
  var exp_date = new Date(document.getElementById('exp_date').value);
  var updated = new Date(document.getElementById('updated').value);
  return exp_date > updated;
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $('#myForm').validate({
    ...
    messages: {
      ...
      checkExpirationDate1: "Expiration date must be later than updated date"
      },
      created: {
